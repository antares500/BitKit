...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "BitTor",             dependencies: ["BitCore", "BitLogger"], path: "Sources/TorSwift"),
        ...
        .target(name: "BitTransport",       dependencies: ["BitCore", "BitState", "BitLogger", "BitGeo", "BitTor", .product(name: "P256K", package: "swift-secp256k1")], path: "Sources/Transport"),
        .target(name: "BitCommunications",  dependencies: ["BitCore", "BitLogger"], path: "Sources/Communications"),
        .target(name: "BitGeo",             dependencies: ["BitCore", "BitLogger", "BitTor"], path: "Sources/Geo"),
