...
public class MeshTopologyTracker {
    ...
    public func updateNeighbors(for sourceData: Data?, neighbors: [Data]) {
    ...
    public func removePeer(_ data: Data?) {
    ...
    public func prune(olderThan age: TimeInterval) {
    ...
    public func computeRoute(from start: Data?, to goal: Data?, maxHops: Int = 10) -> [Data]? {
