...
public enum GCSFilter {
    public struct Params { public let p: Int; public let m: UInt32; public let data: Data }

    // Derive P from FPR (~ 1 / 2^P)
    public static func deriveP(targetFpr: Double) -> Int {
    ...
    public static func estimateMaxElements(sizeBytes: Int, p: Int) -> Int {
    ...
    public static func decodeToSortedSet(p: Int, m: UInt32, data: Data) -> [UInt64] {
        var values: [UInt64] = []
    ...
    public static func contains(sortedValues: [UInt64], candidate: UInt64) -> Bool {
        var lo = 0
    ...
    public static func bucket(for id: Data, modulus m: UInt32) -> UInt64 {
