...
public final class BitMessage: Codable {
...
extension BitMessage: Equatable {
    public static func == (lhs: BitMessage, rhs: BitMessage) -> Bool {
...
extension Array where Element == BitMessage {
