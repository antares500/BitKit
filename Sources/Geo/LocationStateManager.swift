...
public final class LocationStateManager: NSObject, CLLocationManagerDelegate, ObservableObject {
    ...
    public var publicPermissionState: PermissionState { permissionState }
    public var permissionStatePublisher: Published<PermissionState>.Publisher { $permissionState }
...
public typealias LocationChannelManager = LocationStateManager
public typealias GeohashBookmarksStore = LocationStateManager
